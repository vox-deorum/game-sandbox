import type { TerrainRoadSubstrateCell } from '../core/types.js'
import {
  cellAt,
  cellKey,
  compareCells,
...
import { cellCoordinate, EIGHT_DIRECTIONS } from './terrain-route-grid.js'
...
function substrateSources(cells: readonly CellRecord[]): readonly SubstrateSource[] {
