...
describe('Three Branches terrain helpers', () => {
  it('keeps ordered terrain hashes stable for equal input', () => {
    expect(stableHashParts('g', 4, 7)).toBe(stableHashParts('g', 4, 7))
  })
  ...
  it('does not repeat fill variants on a four-cell lattice', () => {
    ...
    expect(terrainVariant(4, 'g', 4, 7)).toBeGreaterThanOrEqual(0)
