...
A Spades agent that bids nil, broadcasts the decision, and covers a partner who does the same. This directory stores only these differences from the composed template:
