...
A Spades agent that sends a partner its strongest side suit and uses the received signal when leading. This directory stores its differences from the composed template:
