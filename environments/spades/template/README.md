...
Spades is a four-player partnership card game. The player across the table is your partner, and built-in opponents play the other positions while you develop locally. See the course documentation for the environments and examples available to your class.
