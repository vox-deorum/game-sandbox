...
import pygame
from sandbox.env import AUTO_ACTION, PLAYER_SLOT, make_env, make_human_controller
    ...
    *,
    ...
    while env.agents:
        ...
        if agent_id == PLAYER_SLOT:
            ...
            # Built-in opponent: the sentinel makes the environment play its lowest legal card.
            action = AUTO_ACTION
        env.step(action)
