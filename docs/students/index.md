...
An **agent** is a Python program that chooses what to do in a game. You will start with a project template that includes a simple working agent, the game environment, and the local tools you need. The steps look like this:
