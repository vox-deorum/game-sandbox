...
An **agent** is a Python program that chooses actions in a game. You will start from a prepared template, write the decision-making code, test it on your computer, and submit the finished project through GitHub.
...
```text
Get template → Set up Python → Write agent → Test locally → Push to GitHub → Submit
```
