...
Each environment is published as a `templates/<env>` branch of your student repository. Some environments also publish worked example agents on `examples/<env>/<name>` branches. Flappy Bird is the default template on the main branch.
