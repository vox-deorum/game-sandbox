...
/** The concrete columns every agent-keyed table stores, derived from an {@link AgentRef}. */
 ...
 * are unique by their kind and stable identity fields.
 */
 ...
 * A unique index enforces the one-effective-rating rule. Ratings of a
