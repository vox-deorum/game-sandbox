...
The configured prop scale defaults to 0.14, overrides bell to 0.36 for both art parts, and overrides pump to 0.33, while bell collision remains a 1.0-cell circle. Drive the result only from prop id, type, state, facing, and tick.
