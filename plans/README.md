...
4. [Stage 4: Frontend core](stage-04-frontend-core.md). The home and environment pages, the Flappy Bird renderer with human input, live play for allowlisted users, the replay viewer, and recording retention. Identity is a single auto-logged-on mock user; GitHub OAuth is deferred as future work behind the same identity seam.
