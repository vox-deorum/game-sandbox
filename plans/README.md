...
7. [Stage 7: LLM gateway](stage-07-llm-gateway.md). The gateway service, the internal-only network, one-off session keys, telemetry sidecars, budgets, the owner debug view, and token columns on the automated board.
