...
The [specification](../docs/specs/index.md) defines the system. This folder tracks how it is built.

- [tactical-game/](tactical-game/README.md) holds the active work: the tactical game specification and its staged implementation plan.
