...
- Human-control coverage verifies the faded activation seal only during open composition, steady seals outside human composition, absent movement pips, reset activation after a selected step, reset restoration of the empty path and movement allowance without an action or clock restart, and sharp step-number resolution after zooming.
