...
4. **Art style and HUD.** The visual identity in two parts, each signed off by the owner: [4.1 art style](stages/4-1-art-style.md), the Estuary Ink board and pieces replacing the placeholder, then [4.2 HUD](stages/4-2-hud.md), the information layer and the step 5 interaction UI, specified with text mockups. Hands-on: both fixture recordings replay in the final style.
