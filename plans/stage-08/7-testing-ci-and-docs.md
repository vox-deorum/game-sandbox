...
- **Contributor docs:** update the [environments guide](../../docs/contributors/environments/) metadata table if the messaging fields need a row, and the [template guide](../../docs/contributors/template.md) for the third template.
